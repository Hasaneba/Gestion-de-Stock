        ...
        <div class="recent-sales box">
            ...
            <div class="sales-details">
                ...
                <ul class="details">
                    ...
                    foreach ($ventes as $key => $value) {
                        ?>
                        <li><a href="#"><?php echo number_format( $value['prix'],0, ",", " "). " MRO"?></a></li>
                        <?php
                    }
                    ?>
                ...
                foreach ($produit as $key => $value) {
                   ...
                   <li>
                    <a href="#">
                        ...
                        <span class="product"><?php echo $value['nom_produit']?></a></span>
                    </a>
                    <span class="price"><?php echo number_format( $value['prix'],0, ",", " "). " MRO"?></span>
                </li>
                   <?php
                }
                ?>
